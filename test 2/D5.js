...
cars[0].licensePlate = "MJ 777JK";
cars[1].licensePlate = "JA 000RD";
cars[2].licensePlate = "BI 989KL";
console.log(cars);
...
for (let i = 0; i < cars.length; i++) {
  if (cars[i].color[0] === "b") {
    console.log(i, cars[i].brand, "Fizz");
  } else {
    console.log(i, cars[i].brand, "Buzz");
  }
}
...
const numerielettere = [];
numerielettere.push(charactersArray);
console.log(numerielettere);
switch (numerielettere) {
  case "g":
    console.log(7);
    break;
